...
from S_matrix.Grating import Sinusoidal,Triangular,Blazed,Rectangular
...
def Set_Polarization(thetai,phi,n1,n2,wavelength,pTE,pTM,m,Nx,accuracy,grating,n,Rough=False):
    ...
    if Rough==True:
        ...
        width=int(grating.fill_factor*Nx)
        q0=Nx//2
        start=q0-width//2
        end=start+width
        mask[start:end]=True
...
#====================================================
Constant=Set_Polarization(0,0,1,1.4482+7.5367j,632.8*1e-9,1,0,50,2**10,1e-9,grating,n=12,Rough=True)

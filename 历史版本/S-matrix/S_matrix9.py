...
grating=Rectangular(4*1e-6,2*1e-6,0.5,"Air","Al","Si",10*1e-6)
...
for i in range(k):
    ...
    epsilon[q0-temp:q0+temp]=grating.n_rd**2
...
# VirtualLab_R=[0,0,0,0.015,0,0.105,0.1844,0.105,0,0.015,0,0,0]
